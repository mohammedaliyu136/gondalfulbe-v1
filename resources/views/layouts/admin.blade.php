...
<head>
    <title>{{ $setting['title_text'] ? $setting['title_text'] : config('app.name', 'Gondal Fulbe') }} - @yield('page-title')
    </title>
    ...
    <style>
        ...
        .dash-header .topbar-inner,
        .dash-header .topbar-left,
        .dash-header .topbar-right {
            display: flex;
            align-items: center;
        }
        ...
        .dash-header .topbar-btn:hover,
        .dash-header .topbar-btn:focus,
        .dash-header .topbar-btn:active {
            background: #f8fafc;
        }
        ...
        .dash-header .user-btn,
        .dash-header .lang-btn {
            justify-content: center;
        }

        .dash-header .topbar-avatar {
            width: 32px;
            height: 32px;
            object-fit: cover;
            border-radius: 10px;
        ...
        .dash-header .topbar-menu {
            min-width: 220px;
            border-radius: 10px;
        }

        .dash-header .topbar-menu .dropdown-item.active,
        .dash-header .topbar-menu .dropdown-item:active {
