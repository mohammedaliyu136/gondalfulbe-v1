...
<div class="modal-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            @php
                $gondalPermissionTabs = \App\Support\GondalPermissionRegistry::roleTabs();
            @endphp
            <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                ...
                @endif
                @foreach ($gondalPermissionTabs as $permissionTab)
                    <li class="nav-item">
                        <a class="nav-link" id="pills-{{ $permissionTab['id'] }}-tab" data-bs-toggle="pill"
                            href="#{{ $permissionTab['id'] }}" role="tab" aria-controls="pills-contact"
                            aria-selected="false">{{ __($permissionTab['label']) }}</a>
                    </li>
                @endforeach
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                @foreach ($gondalPermissionTabs as $permissionTab)
                    <div class="tab-pane fade" id="{{ $permissionTab['id'] }}" role="tabpanel"
                        aria-labelledby="pills-{{ $permissionTab['id'] }}-tab">
                        @include('role.partials.module-permission-table', [
                            'rows' => $permissionTab['rows'],
                            'permissions' => $permissions,
                            'groupClass' => $permissionTab['id'] . '_checkall',
                            'checkAllId' => $permissionTab['id'] . '_checkall',
                            'sectionTitle' => __('Assign :module Permission to Roles', ['module' => __($permissionTab['label'])]),
                            'itemLabel' => __('Section'),
                        ])
                    </div>
                @endforeach
...
<script>
    $(document).ready(function () {
        [
            ...
            $("#" + prefix + "_checkall").click(function(){
                $('.' + prefix + '_checkall').not(this).prop('checked', this.checked);
            });
        });
