...
Route::middleware(['auth'])->group(function () {
    Route::get('/2fa/setup', [Google2FAController::class, 'showSetupForm'])->name('2fa.setup');
    Route::post('/2fa/activate', [Google2FAController::class, 'activate'])->name('2fa.activate');
...
Route::group(['middleware' => ['verified', '2fa']], function () {
    ...
    Route::group(
        ...
        function () {
            Route::resource('farmer', VenderController::class)->names('vender')->parameters(['farmer' => 'vender']);
        }
    );
    ...
    Route::get('export/farmer', [VenderController::class, 'export'])->name('vender.export');
    Route::get('import/farmer/file', [VenderController::class, 'importFile'])->name('vender.file.import');
    Route::post('import/farmer', [VenderController::class, 'venderImportdata'])->name('vender.import.data');
// Route::post('import/farmer', [VenderController::class, 'import'])->name('vender.import');
