...
<div class="modal-body">
    ...
    <div class="row">
        <!-- Sample file omitted, can be added later if needed -->
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                ...
                <input type="hidden" class="form-control" name="table" id="table" value="cooperatives">
            </div>
        </div>
...
<div class="modal-footer">
    ...
    <a href="" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Cooperatives CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
