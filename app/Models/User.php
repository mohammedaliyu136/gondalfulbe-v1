...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return $this->hasMany(\App\Models\Gondal\AgentProfile::class, 'user_id');
    }

    public function supervisedGondalAgentProfiles()
    {
        return $this->hasMany(\App\Models\Gondal\AgentProfile::class, 'supervisor_user_id');
    }
    ...
    {
        $this->attributes['google2fa_secret'] = !empty($value) ? encrypt($value) : null;
    }
