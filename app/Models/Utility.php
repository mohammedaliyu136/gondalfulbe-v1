...
class Utility extends Model
{
    ...
    public static function addNewData()
    {
        ...
        $gondalPermissions = array_values(array_unique(array_merge(
            $legacyGondalPermissions,
            \App\Support\GondalPermissionRegistry::granularPermissions()
        )));

        $arrPermissions = array_merge([
            'manage form builder',
            'create form builder',
            'edit form builder',
            'delete form builder',
        ...
        $companyNewPermission = array_merge([
            'manage form builder',
            'create form builder',
            'edit form builder',
            'delete form builder',
