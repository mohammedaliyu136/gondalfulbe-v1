...
class Project extends Model
{
    ...
    {
        return $this->hasMany(AgentProfile::class, 'project_id', 'id');
    }

    public function programAgentAssignments()
    {
        return $this->hasMany(ProgramAgentAssignment::class, 'project_id', 'id');
    }

    public function programFarmerEnrollments()
    {
        return $this->hasMany(ProgramFarmerEnrollment::class, 'project_id', 'id');
    }
